...
export default {
  ...
  methods: {
    addEntry: function(e) {
      axios
        .post("https://profratingbackend.herokuapp.com/profs/", {
          name: e.name,
          rating: e.rating
        })
        .then(response => {
    ...
    editEntry: function(e) {
      axios
        .put("https://profratingbackend.herokuapp.com/profs/" + e.index, {
          name: e.name,
          rating: e.rating
        })
        .then(response => {
    ...
    removeEntry: function(e) {
      axios.delete("https://profratingbackend.herokuapp.com/profs/" + e.index).then(response => {
        this.listOfEntries = response.data;
      });
    }
  },
  mounted() {
    axios.get("https://profratingbackend.herokuapp.com/profs/").then(response => {
      this.listOfEntries = response.data;
    });
  }
};
